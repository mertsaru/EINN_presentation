...
%TODO L_mono and L_param maybe they are in output network
			\end{itemize}
		\end{column}
...
% \begin{frame}[fragile]{EINN Schema}{Target model (Feature module)}
% 	\begin{columns}
		
% 		\begin{column}[T]{.5\textwidth}
% 			\begin{figure}
% 				\includegraphics[width=0.8\textwidth]{myfigs/schematarget.png}
% 				\caption{Cropped model summary showing the training summary. Cropped from:~\cite{main}}
% 			\end{figure}
% 		\end{column}
...
% \begin{frame}[fragile]{EINN Schema}{Output Network}
% 	\begin{columns}
